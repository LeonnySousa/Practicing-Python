...
def comprar_produto() -> None:
    if len(produtos) > 0:
        print('Informe o codigo do produto que deseja adicioonar ao carrinho: ')
        print('===============================================================')
...
def pega_produto_por_codigo(codigo: int) -> int:
    p: Produto = None
    for produto in produtos:
